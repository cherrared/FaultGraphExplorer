...
def comp (s,m):
 ...
 for e in s:
  if str(s[e])== str(m) :
    b=b+1
 return b 
def SMTAlgo(ObsT, ObsF, ObsN, extend): 
 Appbono2,Appbono1,Apphomestead,Appsprout1,Register21,Chomesteadcass,Appcass,ClusterEventE1,Csprout2homestead,Register11,clusterCsprout1,DCbono1C,Cbono1sprout1,Csprout1homestead,Cbono2sprout2,DCE1C,Appsprout2 =Bools('Appbono2 Appbono1 Apphomestead Appsprout1 Register21 Chomesteadcass Appcass ClusterEventE1 Csprout2homestead Register11 clusterCsprout1 DCbono1C Cbono1sprout1 Csprout1homestead Cbono2sprout2 DCE1C Appsprout2')
 s=Solver()
 ...
 for e in liste:
   if t[0][1][e] == False :
     if valT[e] == 1 :
       ...
       ObsN.append(str(e)) 
       extend= False 
 return(ObsT, ObsF, ObsN, liste, extend)