...
if __name__ == "__main__":
    ...
    Appbono2, Appbono1, Apphomestead, DCbono1S, NB3, Appsprout1, Register21, Chomesteadcass, Appcass, AppE1, DCbono1, Csprout2homestead, Register11, clusterCsprout1, DCbono1C, Cbono1sprout1, Csprout1homestead, Cbono2sprout2, DCE1C, Appsprout2 = Bools(
        'Appbono2 Appbono1 Apphomestead DCbono1S NB3 Appsprout1 Register21 Chomesteadcass Appcass AppE1 DCbono1 Csprout2homestead Register11 clusterCsprout1 DCbono1C Cbono1sprout1 Csprout1homestead Cbono2sprout2 DCE1C Appsprout2'
    )
    s = Solver()
    s.add(
