...
if __name__ == "__main__":
    ...
    while i <= site_num:
      ...
      while j< num_service:
        ...
        BK.v_services(G,site_num, service,elasticity, number_elasticity, Nbi)
        ## Define the application nodes
        
        xcpt=BK.A_services(G,site_num, service,elasticity,number_elasticity,monit,etcd_bool, etcd,xcpt) 
        ...
        while m <= num_VLcon:
         ...
         xcpt= BK.LA_con(G,service,elasticity,number_elasticity, service2, elasticity2_bool,num2, etcd_bool, elasticity3_bool,num3, etcd, xcpt)
         m=m+1
        ...
        while q <= num_VDcon:
         ...
         xcpt= BK.DA_con(G,i,site2,service,elasticity,number_elasticity, service2, elasticity2_bool,num2, etcd_bool, elasticity3_bool,num3, etcd,etcdM_bool, elasticity4_bool,num4, etcdM, xcpt)
